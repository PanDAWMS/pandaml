...
class DataValidator:
    ...
    def validate_prediction(
        cls, df: pd.DataFrame, column: str, acceptable_ranges: dict, jeditaskid: int, logger: logging.Logger
    ) -> bool:
        """
        Validates predictions for a given column and logs the result.
    ...
    def validate_ctime_prediction(
        cls, df: pd.DataFrame, jeditaskid: int, additional_ctime_ranges: dict, logger: logging.Logger
    ) -> bool:
        """
        Validates CTIME predictions using alternative ranges.
